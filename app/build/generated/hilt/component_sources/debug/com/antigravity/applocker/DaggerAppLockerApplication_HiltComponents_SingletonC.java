...
public final class DaggerAppLockerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends AppLockerApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(3).put(LazyClassKeyProvider.com_antigravity_applocker_presentation_dashboard_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_antigravity_applocker_presentation_hidden_HiddenAppsViewModel, HiddenAppsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_antigravity_applocker_presentation_settings_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends AppLockerApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(3).put(LazyClassKeyProvider.com_antigravity_applocker_presentation_dashboard_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_antigravity_applocker_presentation_hidden_HiddenAppsViewModel, ((Provider) hiddenAppsViewModelProvider)).put(LazyClassKeyProvider.com_antigravity_applocker_presentation_settings_SettingsViewModel, ((Provider) settingsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.antigravity.applocker.presentation.settings.SettingsViewModel 
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 8: // com.antigravity.applocker.data.local.datastore.SettingsDataStore 
